...
/home/sgamino/annovar/convert2annovar.pl -format vcf4 ${Dog_ID}_SNPs_filtered_bqsr.vcf > ${Dog_ID}_SNPs_filtered_bqsr.avinput
/home/sgamino/annovar/convert2annovar.pl -format vcf4 ${Dog_ID}_INDELs_filtered_bqsr.vcf > ${Dog_ID}_INDELs_filtered_bqsr.avinput
