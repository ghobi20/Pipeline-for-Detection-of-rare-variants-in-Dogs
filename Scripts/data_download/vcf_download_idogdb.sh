...
wget -r ftp://download.big.ac.cn/idog/dogsd/vcf/canfam4/indel/AutoAndXPAR.nonSNPs.filter.vcf.gz
wget -r ftp://download.big.ac.cn/idog/dogsd/vcf/canfam4/indel/AutoAndXPAR.nonSNPs.filter.vcf.gz.tbi
wget -r ftp://download.big.ac.cn/idog/dogsd/vcf/canfam4/all_SNP.vcf.gz
wget -r ftp://download.big.ac.cn/idog/dogsd/vcf/canfam4/all_SNP.vcf.gz.tbi
